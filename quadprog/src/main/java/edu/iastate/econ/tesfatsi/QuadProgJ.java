/* =======================================================================
 * QuadProgJ : An open-source Java solver for strictly convex quadratic 
 *             programming (SCQP) problems
 * =======================================================================
 *
 * (C) Copyright 2006, by Junjie Sun and Leigh Tesfatsion
 *
 * Project site:  http://www.econ.iastate.edu/tesfatsi/DCOPFJHome.htm
 *
 * LICENSING TERMS
 * The QuadProgJ package is licensed by the copyright holders (Junjie Sun and 
 * Leigh Tesfatsion) as free open-source software under the terms of the GNU
 * General Public License (GPL). Anyone who is interested is allowed to view, 
 * modify, and/or improve upon the code used to produce this package, but any 
 * software generated using all or part of this code must be released as free 
 * open-source software in turn. The GNU GPL can be viewed in its entirety as 
 * in the following site: http://www.gnu.org/licenses/gpl.html
 */
...
public class QuadProgJ {
    ...
    private static final double TOL = 1.0E-9; // TOL: tolerance (in correctRoundingError())
