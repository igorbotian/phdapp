 ...
 */
public final class DataObjectParameterPDU {

    public String name;
    public String value;

    public static DataObjectParameterPDU toPDU(DataObjectParameter param) {
        DataObjectParameterPDU pdu = new DataObjectParameterPDU();
