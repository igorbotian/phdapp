...
public abstract class AbstractClassifierParameterFactory {
     ...
     * @return параметр с заданными характеристиками, значение которого может быть изменено
     ...
     */
    protected <T> MutableClassifierParameter<T> newMutableParameter(String name, Class<T> valueClass, T value,
