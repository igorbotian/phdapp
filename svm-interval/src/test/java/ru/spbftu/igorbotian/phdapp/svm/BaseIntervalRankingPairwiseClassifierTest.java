...
/**
 * Базовый тест для средства классификации данных при интервальном характере данных в обучающей выборке
 *
 * @author Igor Botian <igor.botian@gmail.com>
 */
public abstract class BaseIntervalRankingPairwiseClassifierTest extends BaseRankingPairwiseClassifierTest {
